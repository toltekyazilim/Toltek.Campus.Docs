...
![MenuToogle](/docs/media/modules/course.app/course/course.png)

Eğitimin yönetildiği bu sayfaya Eğitimler sayfasından Eğitim adına tıklayarak da kolayca ulaşabilir.

![Transactions](/docs/media/modules/course.app/course/course_transactions.png)
...
![Summary](/docs/media/modules/course.app/course/course_summary.png)

## Seçenekler

Yönetim Uygulamasında belirlenen eğitim özellikleri Eğitim Uygulamasında değiştirilemez sadece açıklama eklenebilir.

![Course Edit](/docs/media/modules/course.app/course/course_edit.png)
...
![Course Group](/docs/media/modules/course.app/course/course_group.png)

### Şube-Detaylar

Şube detaylarında Fakülte, Birim, Eğitim, Şube Adı ve Katılım bilgileri yer alır.

![Course.Group Details](/docs/media/modules/course.app/course/course_group.png)

### Şube-Seçenekler

Seçenekler bölümünden şube adı değiştirilebilir.

![Course.Group Edit](/docs/media/modules/course.app/course/course_group_edit.png)

### Şube-Raporlar

Önceden belirlenmiş başlıklar altında çeşitli raporları takip edebilir ve Excel dosyası olarak indirilebilir.

![Course.Group Report](/docs/media/modules/course.app/course/course_group_reports.png)
...
![Course Teacher](/docs/media/modules/course.app/course/course_teacher.png)
...
![Course Student](/docs/media/modules/course.app/course/course_student.png)
...
![Course Announce](/docs/media/modules/course.app/course/course_announce.png)
...
![Course Topics](/docs/media/modules/course.app/course/course_topics.png)
...
![Course Question Poor](/docs/media/modules/course.app/course/course_question_poor.png)
...
![Course Virtual Calendar](/docs/media/modules/course.app/course/course_virtual_calendar.png)
...
![Course.VirtualCalendar Details](/docs/media/modules/course.app/course/course_virtual_calendar_details.png)

### S.Takvim-Seçenekler

Sanal takvimin Sağlayıcı, Başlık, Sıra, Gün (Ör: her Cuma), Saat, Süre ve Durum bilgileri değiştirilebilir.

![Course.VirtualCalendar Edit](/docs/media/modules/course.app/course/course_virtual_calendar_edit.png)
...
![Course.VirtualCalendar Group](/docs/media/modules/course.app/course/course_virtual_calendar_group.png)

### S.Takvim-Raporlar

Sanal takvimle ilgili raporlara buradan erişilir ve Excel dosyası olarak indirilebilir.

![Course.VirtualCalendar Report](/docs/media/modules/course.app/course/course_virtual_calendar_report.png)

## Raporlar

Eğitimle ilgili raporlara buradan erişilir ve Excel dosyası olarak indirilebilir.

![Course Report](/docs/media/modules/course.app/course/course_report.png)
